...
const DoctorAppointments = () => {
  const {dToken,appointments,getAllDoctorAppointments,cancelAppointment,completeAppointment}=useContext(DoctorContext)
  ...
  return (
    <div className='w-full max-w-7xl m-5'>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[50vh] over-flow-y-scroll'>
